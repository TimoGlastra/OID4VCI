...
import { ErrorResponse, IssuerCredentialSubject, JsonLdIssuerCredentialDefinition, OID4VCICredentialFormat, TxCode } from './Generic.types';
...
export type TxCodeAndPinRequired = {
...
export declare enum CreateRequestObjectMode {
    NONE = 0,
    REQUEST_OBJECT = 1,
    REQUEST_URI = 2
}
