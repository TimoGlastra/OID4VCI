...
import { Hasher, OriginalVerifiableCredential, WrappedVerifiablePresentation } from '@sphereon/ssi-types';
...
export declare class PresentationExchange {
    ...
    static validatePresentationsAgainstDefinition(definition: IPresentationDefinition, vpPayloads: Array<WrappedVerifiablePresentation> | WrappedVerifiablePresentation, verifyPresentationCallback?: PresentationVerificationCallback | undefined, opts?: {
        limitDisclosureSignatureSuites?: string[];
        restrictToFormats?: Format;
        restrictToDIDMethods?: string[];
        presentationSubmission?: PresentationSubmission;
