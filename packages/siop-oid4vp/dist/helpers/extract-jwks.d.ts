 ...
 */
export declare function fetchJwks(jwksUri: string): Promise<Jwks | undefined>;
/**
 ...
 */
export declare const extractJwksFromJwksMetadata: (metadata: JwksMetadataParams) => Promise<Jwks>;
//# sourceMappingURL=extract-jwks.d.ts.map