...
function signDidJwtExternal(payload, signatureUri, authZToken, alg, kid) {
    return __awaiter(this, void 0, void 0, function* () {
        const body = {
            ...
            expiresIn: did_auth_siop_2.DEFAULT_EXPIRATION_TIME,
            alg,
            selfIssued: payload.iss && payload.iss.includes(did_auth_siop_2.ResponseIss.SELF_ISSUED_V2) ? payload.iss : undefined,
            kid,
        };
...
function isIssSelfIssued(payload) {
    return ((payload.iss && payload.iss.includes(did_auth_siop_2.ResponseIss.SELF_ISSUED_V1)) ||
        (payload.iss && payload.iss.includes(did_auth_siop_2.ResponseIss.SELF_ISSUED_V2)) ||
